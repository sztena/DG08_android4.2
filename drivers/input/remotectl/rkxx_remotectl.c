...
/* keyCode not from input.h. from device/rockchip/rk30sdk/rkxx-remotectl.kl */
...
static struct rkxx_remote_key_table remote_key_table_0x4041[] = {
    {0xB2, KEY_POWER},
    {0xC2, KEY_MUTE},
    {0x22, 388},
    {0x58, KEY_HOME},
...
static struct rkxx_remotectl_button remotectl_button[] = 
{
    ...
    {  
       .usercode = 0x4041, 
       .nbuttons = 28, 
       .key_table = &remote_key_table_0x4041[0],
    },
    {  
       .usercode = 0xdf, 
       .nbuttons =  16, 
