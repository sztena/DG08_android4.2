...
#ifdef CONFIG_MACH_RK30_DONGLE_TN_DG08
	/* add by marco. power off wifi voltage. */
	struct regulator *ldo;
	ldo = regulator_get(NULL, "vdac"); /* close mmc1 sdio voltage */
	printk("[MARCO]%s disable vdac vcca33=%dmV end\n", __func__, regulator_get_voltage(ldo));
	regulator_disable(ldo); 
	msleep(200);
	ldo = regulator_get(NULL, "vaux2");	/* close mmc1 wifi voltage */
	printk("[MARCO]%s disable vaux2 vcca33=%dmV end\n", __func__, regulator_get_voltage(ldo));
	regulator_disable(ldo);
#endif
